...
function classifyBatchWithGemini_(geminiKey, pages, config) {
  var promptParts = [
    ...
    "- LOW PRIORITY (Score 60-79): Generic SWE, backend SWE, or fullstack roles without any AI/ML focus. You MUST score pure generic SWE roles below 80.",
    "",
    ...
    "",
    "Scoring: 95+ exact match on Agentic AI / RL / Agent Observability; 85-94 applied ML/DL/AI intern; below 80 if generic SWE without AI focus, full-time, lab biology/hardware, or irrelevant.",
...
function classifyNewGradBatchWithGemini_(geminiKey, pages, config) {
  var promptParts = [
    ...
    "- 80-89: AI/ML focused technical early-career role at a startup or tech company in the Bay Area or Remote US.",
    "- Below 80: Generic SWE without AI focus, irrelevant, nontechnical, internship/co-op, senior, or outside the experience range.",
    "",
    "Prefer San Francisco, Bay Area, Silicon Valley, Remote US, or US roles. Exclude Workday pages.",
    "If the page URL is an aggregator like Jobright (jobright.ai) or Wellfound, you MUST scan the page text for the actual original ATS application link (e.g., boards.greenhouse.io, jobs.lever.co, jobs.ashbyhq.com) and return THAT exact ATS URL in the \"url\" field instead of the aggregator URL. If it's already a direct ATS page, use its URL exactly.",
    "",
